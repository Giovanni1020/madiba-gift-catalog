...
const WHATSAPP_MESSAGE =
  "Olá, gostaria de ver as opções e disponibilidade de buquê customizado (+10 rosas)";
  ...
  return (
    <article className="card card--custom">
      ...
      <div className="card__body">
        <span className="card__category">Buquês</span>
        <h3 className="card__name">Buquê customizado</h3>
        <p className="card__desc">
          Entre em contato no WhatsApp para ver a disponibilidade de buquês
          customizados a partir de 10 rosas.
        </p>
        <div className="card__footer card__footer--custom">
          <a
            ...
            aria-label="Contatar no WhatsApp sobre buquê customizado"
          >
            <svg
              width="18"
              height="18"
