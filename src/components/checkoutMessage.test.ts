...
test("separa itens e seções com linha em branco", () => {
  const msg = buildWhatsAppMessage({
    ...
    entrega: {
      ...
      data: "2026-06-10",
      horario: "14h às 15h",
      endereco: { cidade: "Porto Alegre", rua: "Rua das Flores", numero: "123", bairro: "Centro", complemento: "Apto 42" },
    },
  });
  ...
  expect(msg).toContain(
    "Forma: Entrega\nQuem recebe: João Silva\nEndereço: Rua das Flores, 123, Centro, Porto Alegre, Apto 42\nDia: 10/06/2026\nHorário: 14h às 15h\n\nCliente: Maria — (51) 98508-2700",
  );
});
...
test("endereço sem complemento não acrescenta vírgula extra", () => {
  const msg = buildWhatsAppMessage({
    ...
    entrega: {
      ...
      data: "2026-06-05",
      horario: "10h às 11h",
      endereco: { cidade: "Canoas", rua: "Av. Brasil", numero: "10", bairro: "Centro", complemento: "" },
    },
  });

  expect(msg).toContain("Endereço: Av. Brasil, 10, Centro, Canoas\nDia: 05/06/2026\nHorário:");
});
