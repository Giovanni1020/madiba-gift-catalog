...
| [achados-pre-migracao.md](achados-pre-migracao.md) | **Achados de código (F1–F10)** levantados no desenho dos E2E da v1.2: pré-requisitos do smoke set, superfície morta, falsos positivos verificados e as decisões de execução da fase. |
